          ...
          child: Card(
              ...
              child: Column(
                  ...
                  children: [
                     Text(
                      "Your Score",
                      style: TextStyle(fontSize: 30, color: kprimaryRed),
                    ),
                    const SizedBox(
                      height: 10,
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ElevatedButton(
                           style: ButtonStyle(
                backgroundColor: MaterialStateProperty.all(kprimaryRed),),
                            onPressed: () {
                        ...
                        ElevatedButton(
                            style: ButtonStyle(
                backgroundColor: MaterialStateProperty.all(kprimaryOrange),),
